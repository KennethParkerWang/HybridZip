...
class RansBackend final : public IBlockEntropyBackend {
public:
    const char* name() const noexcept override { return "rans"; }
    EntropyKind kind() const noexcept override { return EntropyKind::Rans; }
